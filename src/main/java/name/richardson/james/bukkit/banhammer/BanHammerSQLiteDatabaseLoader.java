 ...
 *
 * BanHammerSQLiteDatabaseLoader.java is part of ban-hammer.
 *
...
public class BanHammerSQLiteDatabaseLoader extends SQLiteDatabaseLoader {
	...
	public BanHammerSQLiteDatabaseLoader(final DatabaseConfiguration configuration) {
		super(configuration);
	}
	...
	@Override protected void afterDatabaseCreate() {
		...
		UUIDFetcher uuidFetcher = new UUIDFetcher(playerNames, false);
		...
		LOGGER.info(nameUUIDMap.toString());
