...
public class NewBanRecord implements BanRecord {
	 ...
	 * The creator.
	 */
	@ManyToOne(targetEntity = NewPlayerRecord.class, fetch = FetchType.EAGER, cascade = {CascadeType.PERSIST})
	...
	public name.richardson.james.bukkit.banhammer.ban.BanRecordFormatter getFormatter() {
		return new NewBanRecord.BanRecordFormatter(this);
	}
