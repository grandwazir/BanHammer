...
public interface BanHammerAPI {
   ...
   * @param senderName
   * The name of the person doing the banning. If called by a plugin without
   * user intervention this should be the name of the plugin.
   * @param reason
   * The reason why the player has been banned.
   * @param expiryTime
   * A Long representing how many milliseconds the player should be banned for.
   * For permanent bans you should specify 0.
   * @param notify
   ...
   * 
   * This will only return details of an active ban, one that is preventing them
   ...
   * 
   * This will provide a CachedBan providing access to all the related data, but
   * no ability to change or modify the actual record.
   * 
   * @param player
   * The name of the player to check (search is case insensitive).
   ...
   * 
   * This only checks to see if the player has an active ban, one that is
   * preventing them from logging into the server.
   ...
   * @param senderName
   * - The name of the person doing the pardoning. If called by a plugin without
   * user intervention this should be the name of the plugin.
   * @param notify
   * - if true, players are not notified of the ban.
