...
public class NewPlayerRecord implements PlayerRecord {

	/** The bans. */
	@OneToMany(mappedBy = "player", targetEntity = NewBanRecord.class, cascade = { CascadeType.REMOVE })
	private List<BanRecord> bans;
	/** The created bans. */
	@OneToMany(mappedBy = "creator", targetEntity = NewBanRecord.class)
