...
public class UndoCommand extends AbstractSynchronousCommand {
	...
	public UndoCommand(final Plugin plugin, final BukkitScheduler scheduler, BanHammerPluginConfiguration configuration) {
	...
	protected void execute() {
		...
		for (String playerName : playerNames) {
			...
			} else if (!isWithinTimeLimit(ban.getCreatedAt().getTime())) {
	...
	private boolean isWithinTimeLimit(final long time) {
